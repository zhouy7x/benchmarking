...
#WORKLOAD_DIR=$2  ### This is where Node-DC-EIS script is located
REL_DIR=$(dirname $0)
...
WORKLOAD_DIR=${SCRIPT_DIR}/Node-DC-EIS
...
function create_client_config() {
    ...
    cp ${WORKLOAD_DIR}/Node-DC-EIS-client/config.json ${WORKLOAD_DIR}/Node-DC-EIS-client/config-local.json 2>&1 | tee -a $RESULTSLOG
